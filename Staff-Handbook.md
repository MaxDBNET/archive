...
| Ghosting (Slender, and Deathrun) | Revealing information as a dead/spectator to players that are alive and otherwise wouldn't know                                                                      | :x: <br /> - "There's a page at `X, Y`" <br /> - "The death is not on the button yet, run!"                                                                                                                                                                                                                    | Initial warning and if continued, a mute |
...
|      Bypassing Ban/Mute       | Using an alternate account to bypass a ban/mute and arguging against the punishment       | :x: <br /> - "Wtf you muted me, that's not even a rule, you're a bad staff" <br /> <br /> :white_check_mark: <br /> - "Lol, I got muted on my main account" | Initial warning and if continued, an IP ban             |
